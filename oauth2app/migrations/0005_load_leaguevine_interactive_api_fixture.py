...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "leaguevine_interactive_api_fixture.json")
    ...
    models = {
        ...
        'oauth2app.accesstoken': {
            ...
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1323704949'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1323701349'}),
            'mac_key': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'null': 'True', 'default': "'d829be23f9'", 'max_length': '10', 'blank': 'True', 'unique': 'True', 'db_index': 'True'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'c49d8899b6'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'}),
        ...
        'oauth2app.client': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'c3cd0ec54e2265626efabace6a4946'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'890b793151ca815419edb73431c2db'", 'unique': 'True', 'max_length': '30'}),
        ...
        'oauth2app.code': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['oauth2app.Client']"}),
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1323701469'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1323701349'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'383aa131dd75c6dd68f351b9dcc903'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'scope': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['oauth2app.AccessRange']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
